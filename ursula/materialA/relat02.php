...
$dados .= "<h2 style='text-align: center;'>Viajando na maionese <img src='http://localhost/topicos/ursula/materialA/img/instagram.png' height='35' width:'40'</h2>";
$dados .="<table>
          <thead>
          <tr>
          <th>ID</th>
